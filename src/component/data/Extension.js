...
class InlineAsyncExtension extends React.PureComponent<{
    ...
    widthTimeoutId: number | undefined;
...
export const extensionHandlers: ExtensionHandlers = {
    ...
    'com.poovarasan.extensions.update': {
        render: ext => {
    ...
    'com.poovarasan.extensions.noupdate': {
        render: () => {
